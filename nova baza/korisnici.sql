...
--
-- Host: localhost    Database: korisnici
-- ------------------------------------------------------
...
CREATE TABLE `administrator` (
  ...
  PRIMARY KEY (`id`),
  KEY `idosoba_fk_idx` (`id_osoba`),
  CONSTRAINT `idosoba_fk` FOREIGN KEY (`id_osoba`) REFERENCES `osoba` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `administrator` VALUES (1,1),(2,2),(3,3),(4,4);
...
CREATE TABLE `korisnik` (
  ...
  `id_osoba` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `idOsobaFK_idx` (`id_osoba`),
  KEY `idTrenerFk_idx` (`id_trener`),
  CONSTRAINT `idOsobaFK` FOREIGN KEY (`id_osoba`) REFERENCES `osoba` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `idTrenerFk` FOREIGN KEY (`id_trener`) REFERENCES `trener` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `trener` (
  ...
  `broj_klijenata` int(11) DEFAULT NULL,
...
INSERT INTO `trener` VALUES (1,'musko',25,'fax',2,12,5),(2,'zensko',16,'fax',3,10,6),(3,'zensko',28,'fax',5,25,7),(4,'musko',30,'edukacija',9,30,8),(5,'musko',35,'ekukacija',13,55,9);
...
-- Dump completed on 2017-06-01 16:18:28
